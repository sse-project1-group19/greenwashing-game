...
export const UPGRADES: Upgrade[] = [
  ...
  },
  {
    ...
    moneyPerTick: 75,
    pollutionPerTick: 40,
    educationalMessage: "Hardware companies market devices as their 'first carbon-neutral product' by buying carbon credits (like planting trees in Kenya). However, investigations show these credits are often short-term, worthless, and fail to provide genuine long-term carbon reductions.",
    realWorldEvidence: "Apple faced a US class-action lawsuit and was banned by a German court from advertising the Apple Watch as 'CO2-neutral' due to its reliance on highly questionable offset projects.",
    source: "Trellis",
  ...
  },
  {
    ...
    cost: 2500,
    perceptionImpact: 10,
    educationalMessage: "Mega-retailers create slick, highly-marketed 'Pledges' to achieve net-zero in the distant future. Because there is no legal accountability, they use it as an ESG marketing shield while their actual direct transportation emissions skyrocket.",
    realWorldEvidence: "Amazon launched the highly publicized 'Climate Pledge', but its total carbon emissions have increased by approximately 40% between 2019 and 2022.",
    source: "New Climate Institute",
    sourceUrl: "https://newclimate.org/sites/default/files/2024-08/NewClimate_CCRM2024.pdf#:~:text=The%20first%20iteration%20of%20the%20CCRM%2C%20published,to%20be%20aligned%20with%201.5%C2%B0C%20compatible%20pathways."
  },
  {
    id: 8,
    name: "PFC Abatement Accounting",
    description: "Boast about new factory 'scrubbers' to show a 90% efficiency gain, carefully masking the massive overall increase in your absolute emissions.",
    category: "perception",
    cost: 5000,
    perceptionImpact: 15,
    educationalMessage: "Semiconductor manufacturing relies heavily on Perfluorocompounds (PFCs)—gases up to 23,000 times more potent than CO2. Chipmakers generate incredible PR by installing abatement scrubbers and bragging about 'efficiency reductions per wafer.' However, they use this metric to deliberately mask the fact that their absolute, total climate emissions are constantly skyrocketing due to massive production volume growth.",
    realWorldEvidence: "Major semiconductor companies frequently publish sustainability reports highlighting their successful 'per-chip' greenhouse gas reductions, even as their actual total corporate carbon and PFC emissions double and triple over the exact same period.",
    source: "The Guardian",
